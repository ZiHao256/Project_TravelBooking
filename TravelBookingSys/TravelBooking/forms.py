...
class AdminLoginForm(forms.Form):
    adminID = forms.IntegerField(label="adminID")
    password = forms.CharField(label="password", max_length=50, widget=forms.PasswordInput)


class AdminRegisterForm(forms.Form):
    adminName = forms.CharField(label="name", max_length=50, widget=forms.TextInput(attrs={'class': 'form-control'}))
...
class CustRegisterForm(forms.Form):
    custName = forms.CharField(label="name", max_length=50, widget=forms.TextInput(attrs={'class': 'form-control'}))
